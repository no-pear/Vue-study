...
// 1. 导入模块
// 2. 注册模块
var patch = (0, _init.init)([_style.styleModule, _eventlisteners.eventListenersModule]); // 3. 使用 h() 函数的第二个参数传入模块所需要的数据（对象）
...
}, [(0, _h.h)('h1', 'hello snabbdom'), (0, _h.h)('p', 'this is a p label')]);
