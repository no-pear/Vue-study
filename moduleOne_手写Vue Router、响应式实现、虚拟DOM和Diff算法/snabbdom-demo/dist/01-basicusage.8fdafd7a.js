...
var patch = (0, _init.init)([]); // h  参数（标签+选择器，如果是字符串的话就是标签中的内容）
...
var app = document.querySelector('#app'); // patch函数有两个参数。第一个是表示当前视图的DOM元素或vnode。第二个是表示更新后的新视图的vnode。
// 第一个参数：可以是 DOM 元素，内部会把 DOM 元素转换成 VNode
// 第二个参数：VNode
// 返回值：VNode

var oldVnode = patch(app, vnode); // 更新数据

var newVnode = (0, _h.h)('div', 'hello snabbdom');
