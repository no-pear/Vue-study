...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/index.vue?vue&type=template&id=4bc5c7eb&
...
// CONCATENATED MODULE: ./pages/article/index.vue?vue&type=template&id=4bc5c7eb&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-meta.vue?vue&type=template&id=19e8b403&
var article_metavue_type_template_id_19e8b403_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"article-meta"},[_c('nuxt-link',{attrs:{"to":{
      name: 'profile',
      params: {
...
var article_metavue_type_template_id_19e8b403_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-meta.vue?vue&type=template&id=19e8b403&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  article_metavue_type_template_id_19e8b403_render,
  article_metavue_type_template_id_19e8b403_staticRenderFns,
  false,
  injectStyles,
  null,
  "5030066e"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-comments.vue?vue&type=template&id=e1e9f91e&
var article_commentsvue_type_template_id_e1e9f91e_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<form class=\"card comment-form\"><div class=\"card-block\"><textarea placeholder=\"Write a comment...\" rows=\"3\" class=\"form-control\"></textarea></div> <div class=\"card-footer\"><img src=\"http://i.imgur.com/Qr71crq.jpg\" class=\"comment-author-img\"> <button class=\"btn btn-sm btn-primary\">Post Comment</button></div></form> "),_vm._l((_vm.comments),function(comment){return _vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-block\"><p class=\"card-text\">"+_vm._ssrEscape("\n        "+_vm._s(comment.body)+"\n      ")+"</p></div> "),_vm._ssrNode("<div class=\"card-footer\">","</div>",[_c('nuxt-link',{staticClass:"comment-author",attrs:{"to":{
              name: 'profile',
              params: {
...
var article_commentsvue_type_template_id_e1e9f91e_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-comments.vue?vue&type=template&id=e1e9f91e&
...
/* harmony default export */ var article_commentsvue_type_script_lang_js_ = ({
  ...
  async mounted() {
    const {
      data
    } = await Object(api_article["e" /* getComments */])(this.article.slug); //   console.log("mounted -> data", data)
...
var article_comments_component = Object(componentNormalizer["a" /* default */])(
  ...
  article_commentsvue_type_template_id_e1e9f91e_render,
  article_commentsvue_type_template_id_e1e9f91e_staticRenderFns,
  false,
...
/* harmony default export */ var articlevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const {
      data
    } = await Object(api_article["c" /* getArticle */])(params.slug); // console.log("Data -> data", data)

    const {
      article
    } = data;
    const md = new external_markdown_it_default.a(); //把 markdown 格式的字符串转成 html 形式的字符串
